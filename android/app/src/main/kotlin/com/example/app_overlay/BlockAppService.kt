...
class BlockAppService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (flutterEngine != null) {
            // Navigate to the block overlay route
            flutterEngine.navigationChannel.setInitialRoute("/block_overlay")
            
            // Create a FlutterView using the cached engine
            val flutterView = FlutterView(this)
            flutterView.attachToFlutterEngine(flutterEngine)
            
            // Use the Flutter view as the overlay
            overlayView = flutterView
        } else {
            // Fallback to XML layout if Flutter engine is not available
