package com.example.app_overlay
...
// Add this constant
const val FLUTTER_ENGINE_ID = "block_overlay_engine"
...
class MainActivity: FlutterActivity() {
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        // Cache the main Flutter engine for reuse by the service
        ...
        fun checkQueryAllPackagesPermission(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                PackageManager.PERMISSION_GRANTED == context.checkSelfPermission(android.Manifest.permission.QUERY_ALL_PACKAGES)
            } else {
                true
            }
        }
        ...
        fun requestQueryAllPackagesPermission(activity: Activity): Boolean {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                if (activity.checkSelfPermission(android.Manifest.permission.QUERY_ALL_PACKAGES) != PackageManager.PERMISSION_GRANTED) {
                    activity.requestPermissions(arrayOf(android.Manifest.permission.QUERY_ALL_PACKAGES), 2)
                    return false
                }
            }
            return true
